...
export default function Portfolio() {
  ...
  const timeline = [
    { year: '2023', title: 'Début du DUT en Génie Informatique', description: 'Commencé mon parcours académique à l\'IUT de Douala.' },
    { year: '2024', title: 'Premiers projets personnels', description: 'Création d\'Obsidian Club et exploration des frameworks modernes.' },
